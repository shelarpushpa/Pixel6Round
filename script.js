...
{
     var ar=name.split(' ');
     var otp=Math.floor(Math.random() * (9000 - 1000) + 1000);
     //window.location("otp.html");  
      document.write("Dear  "+ar[0]+" Thank you for your inquiry. A 4 digit verification number has been sent to your phone number: "+phone+"(For OTP validation i have show genrerated OTP in this msg ) Your Otp:"+otp+"  please enter in the following box and submit for confirmation:");
     ...
     //document.getElementById("demo1").innerHTML = "Dear  "+ar[0]+" Thank you for your inquiry. A 4 digit verification number has been sent to your phone number: "+phone;*/
     return true;
}
